      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route path="/" element={<Root/>}>
            ...
            <Route path="/calendrier/:id" element={<CalendarEvent/>}/>  // Route pour un événement du calendrier
            <Route path="/eventform" element={<AddEventForm/>}/>  // Route pour le formulaire d'ajout d'événement
            ...
            <Route path="/appointment" element={<AppointmentList/>}/>  // Route pour la liste des rendez-vous
            <Route path="/documents" element={<Documents/>}/>  // Route pour les documents
            <Route path="/Galerie" element={<CategoryList/>}/>  // Route pour la liste des catégories de la galerie
            <Route path="/Galerie/:categoryId" element={<CategoryDetail/>}/>  // Route pour une catégorie spécifique de la galerie
